...
/**
 * Panel de indicadores de gerencia (HU08). El periodo se cambia sin recargar.
 */
new #[Layout('components.layouts.app', ['titulo' => 'Panel de indicadores'])] class extends Component
{
    #[Url(except: '')]
    ...
    {
        return PeriodoReporte::tryFrom($this->periodo) ?? PeriodoReporte::Dia;
    }

    #[Computed]
    public function resumen(): ResumenIndicadores
    {
