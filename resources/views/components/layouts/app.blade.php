        ...
        <div class="mx-auto max-w-6xl px-4">
            ...
            <div class="flex items-center gap-3 py-3">
                ...
                <div class="ml-auto flex items-center gap-3">
                    <p class="hidden leading-tight lg:block">
                    ...
                    <button type="button" @click="abierto = ! abierto" :aria-expanded="abierto ? 'true' : 'false'"
                        ...
                        class="grid size-11 place-items-center rounded-full border-2 border-coffee-300 text-coffee-700 transition hover:bg-coffee-50 focus:outline-none focus-visible:ring-4 focus-visible:ring-coffee-700/25 lg:hidden">
            ...
            <nav class="hidden flex-wrap items-center gap-x-6 gap-y-2 pb-3 text-sm lg:flex" aria-label="Secciones">
            ...
            <div id="menu-movil" x-show="abierto" x-cloak x-transition.origin.top
                class="border-t border-coffee-200 py-3 lg:hidden">
