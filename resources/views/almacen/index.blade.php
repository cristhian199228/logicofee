<x-layouts.app titulo="Panel de almacén">
                ...
                <div class="mt-3 space-y-3">
                    @foreach ($grupo['lotes'] as $lote)
                        ...
                        <article @class([
                            ...
                            @if ($puedeMoverAlmacen)
                                <form method="POST" action="{{ route('lotes.baja.store', $lote) }}"
                                    class="mt-3 grid gap-3 border-t border-coffee-200/70 pt-3 sm:grid-cols-[8rem_1fr_auto]">
                                    @csrf
                                    ...
                                    <div>
                                        ...
                                        <input type="number" id="cantidad-{{ $lote->id }}" name="cantidad" required
                                            min="1" max="{{ $lote->cantidad_disponible }}"
                                            value="{{ $errors->getBag($bolsa)->any() ? old('cantidad') : $lote->cantidad_disponible }}"
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="motivo-{{ $lote->id }}" name="motivo" required
                                            placeholder="Ej. Lote vencido, retirado del almacén"
                                            value="{{ $errors->getBag($bolsa)->any() ? old('motivo') : '' }}"
                                    ...
                                    <div class="flex items-end">
                                        <button type="submit"
                                            class="w-full rounded-xl border-2 border-ladrillo-500 px-5 py-2 text-sm font-semibold text-ladrillo-500 transition hover:bg-ladrillo-500 hover:text-white focus:outline-none focus-visible:ring-4 focus-visible:ring-ladrillo-500/25">
                                            Dar de baja
                                        </button>
                                    </div>
                                </form>
